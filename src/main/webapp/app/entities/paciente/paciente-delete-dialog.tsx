...
export const PacienteDeleteDialog = (props: IPacienteDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="proyectoPracticaApp.paciente.delete.question">
        <Translate contentKey="proyectoPracticaApp.paciente.delete.question" interpolate={{ id: pacienteEntity.id }}>
